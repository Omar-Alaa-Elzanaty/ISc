...
namespace ISC.API.Controllers
{
    ...
    public class MentorController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<IActionResult> DisplayAttendence(int campId)
        {
            ...
            var trainees = await _userManager.Users
                                .Include(a => a.Trainee)
                                .Where(a => a.Trainee != null && traineesIds.Contains(a.Trainee.Id) && a.Trainee.MentorId == mentorId && a.Trainee.CampId == campId)
                                .Select(a => new
                                {
                                    a.Trainee.Id,
        ...
        {
            var userId = User.FindFirst(ClaimTypes.NameIdentifier)?.Value;
            return Ok(await _mentorServices.MentorInfoAsync(userId!));
        }
        //TODO: to implement
        //[HttpGet]
